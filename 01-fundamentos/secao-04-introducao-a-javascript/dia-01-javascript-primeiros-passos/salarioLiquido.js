...
else if (salariobase > 1.903,98 && salario <= 2.826,65){
    ir = (salariobase * 0.075) - 142.8;
}
else if (salariobase > 2.826,65 && salario <= 3.751,05){
    ir = (salariobase * 0.150) - 354.8;
}
else if (salariobase > 3.751,05 && salario <= 4.664,68){
